...
const Profile: FC = () => {
	...
	return (
		<div className="bg-slate-400 h-screen w-full flex flex-col">
			...
			{/* CONTENT CONTAINER */}
			<div className="w-full flex-1 justify-self-stretch self-stretch flex flex-row items-center relative">
				...
				>
					<svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-4" viewBox="0 0 16 16" fill="currentColor">
				...
				{/* PROFILE CONTAINER */}
				<div className="h-full w-full bg-slate-200 flex-1 justify-self-stretch self-stretch flex flex-col justify-items-center items-stretch px-32 py-24 gap-10">
					...
					{/* DESCRIPTION */}
					<div>
						<div className="flex gap-4 text-acm-main text-xl uppercase mb-2">Description</div>
						...
						{editMode ? (
							...
							<p>
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed congue eleifend ante id dictum. Quisque pretium
								leo a congue laoreet. Aliquam ultrices tristique gravida. Aliquam ultrices tristique gravida. Aliquam
								ultrices tristique gravida.
							</p>
						)}
					</div>
					...
					{/* SKILLS */}
					<div>
						<div className="flex gap-4 text-acm-main text-xl uppercase mb-2 w-full">Skills</div>
					...
					{editMode && (
						<div className=" ">
							<div className="flex gap-4 text-acm-main text-xl uppercase mb-2 w-full">Add Skill</div>
